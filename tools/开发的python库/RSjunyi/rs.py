...
tar_train = r"D:\Gentry\Data\High Resolution RS data\BDCI2017-jiage-Semi\training\Random Generat\trains"
tar_label = r"D:\Gentry\Data\High Resolution RS data\BDCI2017-jiage-Semi\training\Random Generat\labels"
...
def gamma_transform(img, gamma):
    gamma_table = [np.power(x/255.0, gamma) * 255.0 for x in rang(256)]
...
def img_clip(imgs, labels, clip_num, img_h = 256, img_w = 256, agument = False):
    '''
    ...
    while True:
        ...
        for i in range(len(data)):
            ...
            if batch % batch_size == 0:
                ...
                valid_label = labelencoder.transform(train_label)  # 编码，这个方法还需要掌握
                valid_label = to_categorical(train_label, num_classes=n_label)  # 编码输出便签
                valid_label = train_label.reshape((batch_size, img_w, img_h, n_label))
